                     ...
                     <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang805" placeholder="Featured Links" required=""
                                value="{{ $lang->lang805 }}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" class="input-field" name="lang806" placeholder="Popular Products" required=""
                                value="{{ $lang->lang806 }}">
                            </div>
                          </div>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang55" placeholder="Buy" required="" value="Buy">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang811" placeholder="Preview" required=""
                              value="Preview">
                          </div>
                        </div>
                      ...
                      <hr>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                              <h4 class="heading">Month e.g. 12 *</h4>
                              <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang165" placeholder="Month e.g. 12" required=""
                              value="{{ $lang->lang165 }}">
                          </div>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-7">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                              <h4 class="heading"> Preview Link *</h4>
                              <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang812" placeholder="Preview Link"
                              required="" value="{{ $lang->lang812 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                              <h4 class="heading"> Enter Preview Link *</h4>
                              <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang813" placeholder="Enter Preview Link"
                              required="" value="{{ $lang->lang813 }}">
                          </div>
                        </div>
