            ...
            <form id="geniusform" action="{{ route('admin-ps-homeupdate') }}" method="POST"
              ...
              <div class="row justify-content-center">
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="slider">{{ __('Slider & Featured Links') }} *</label>
                  <label class="switch">
                ...
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="featured_category">{{ __('Featured Banner') }} *</label>
                  <label class="switch">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-4 d-flex justify-content-between">
                    <label class="control-label" for="hot_sale">{{ __('Popular Products') }} *</label>
                    <label class="switch">
